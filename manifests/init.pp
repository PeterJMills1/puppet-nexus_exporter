class nexus_exporter (
  ...
  $script_location         = $nexus_exporter::params::script_location,
  $script_name             = $nexus_exporter::params::script_name,
  $config_location         = $nexus_exporter::params::config_location,
  $config_name             = $nexus_exporter::params::config_name,
